...
import type { Lane, RunType } from "./types";

export const RUN_TYPE_LABEL: Record<RunType, string> = { local: "Local", regional: "Regional", otr: "Long haul" };
...
const RADIUS_MILES: Record<RunType, number> = { local: 150, regional: 550, otr: Infinity };
...
/** Whether a lane is work this driver would actually take: both ends inside their radius, and for a local driver a
 *  run short enough to still get home the same night. */
